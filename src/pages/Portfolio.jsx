...
const shortTermGoals = [
  {
    label: 'Ship FilterMail to 1,000 users',
    body: 'Get the Chrome extension in front of real users, iterate based on feedback, and build a distribution habit.',
  },
  {
    label: 'Secure an ML/data internship',
    body: "Land a summer role where I'm working directly on production ML systems, not just tooling around them.",
  },
  {
    label: 'Contribute to open source',
    body: "Make meaningful contributions to a project I actually use — not just bug fixes, but something with architectural weight.",
  },
  {
    label: 'Deepen systems knowledge',
    body: 'Work through OS and distributed systems fundamentals so I can reason about performance from first principles, not intuition.',
  },
]
...
const courseProjects = [
  ...
  },
  {
    ...
    course: 'EECS 3421 — Introduction to Database Systems',
  ...
  },
  {
    ...
    course: 'EECS 3214 — Computer Network Protocols',
  ...
  },
  {
    ...
    course: 'EECS 3221 — Operating System Fundamentals',
...
export default function Portfolio() {
  ...
  return (
    <div className="min-h-screen pt-24">
      ...
      {/* 2. Long-Term Goals — reused from Goals component */}
      <Goals />
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <FadeIn delay={0.1}>
            <p className="text-slate-400 text-base leading-relaxed max-w-3xl mb-14">
              These are the concrete things on my agenda for the next twelve months — specific enough
              to measure, ambitious enough to matter.
            </p>
          </FadeIn>
          <div className="grid sm:grid-cols-2 gap-5">
            {shortTermGoals.map((goal, i) => (
              <FadeIn key={goal.label} delay={0.15 + i * 0.1} direction="up">
                <div className="h-full p-6 rounded-xl border border-slate-800 bg-slate-900/40 hover:border-blue-500/30 transition-colors duration-300 flex flex-col gap-3">
                  ...
                  <p className="text-slate-400 text-sm leading-relaxed">{goal.body}</p>
                </div>
              </FadeIn>
            ))}
          </div>
